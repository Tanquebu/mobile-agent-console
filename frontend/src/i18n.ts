...
export const translations = {
  it: {
    ...
    agyFullPermissionsLabel: "Tutti i permessi da subito (bypassa le conferme)",
    agyFullPermissionsHint: "L'agente non chiederà conferma per modifiche o comandi eseguiti.",
  ...
  en: {
    ...
    agyFullPermissionsLabel: "Grant all permissions upfront (skip confirmations)",
    agyFullPermissionsHint: "The agent will not ask for confirmation before making changes or running commands.",
