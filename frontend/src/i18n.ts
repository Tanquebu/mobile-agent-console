...
export const translations = {
  it: {
    ...
    invalidFilenamePattern: "Sono ammessi lettere, numeri, underscore (_) e trattini (-), senza spazi.",
  ...
  en: {
    ...
    invalidFilenamePattern: "Letters, numbers, underscores (_) and hyphens (-) are allowed, without spaces.",
